                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">查看所有文档</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="container">
    <h1>Microsoft Flow 文档</h1>
    <ul class="pivots">
        <li>
            <a href="#start">我刚开始接触</a>
            <ul id="start">
                <li>
                    <a href="#start-all"></a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>跟着导览一起学习</h3>
                                            <p>从这一套按顺序学习的课程入手，开始全面了解 Microsoft Flow 的强大功能。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>基础知识入门</h3>
                                            <p>使用 Microsoft Flow 实现工作和生活自动化的快速入门。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>追看每周的精彩流</h3>
                                            <p>直接向 Microsoft Flow 团队学习新技巧。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>协作处理团队流</h3>
                                            <p>利用 Microsoft Flow 可以轻松地自动执行重复任务。 可以将用户或组添加为所有者，再与他们协作设计和管理流。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>为组织管理 Microsoft Flow</h3>
                                            <p>了解如何在 Microsoft Flow 中创建、使用和管理环境。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>了解如何结合使用 REST API 和流</h3>
                                            <p>从自己的应用程序中调用 Microsoft Flow。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>创建自定义连接器</h3>
                                            <p>生成可以在 Azure 逻辑应用、Microsoft Flow 或 Microsoft PowerApps 中使用的自定义连接器。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
